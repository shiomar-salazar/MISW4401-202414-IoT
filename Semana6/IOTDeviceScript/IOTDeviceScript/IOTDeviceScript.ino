...
const char ssid[] = "FamSaGu_Sala"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "02022020-AkeShio"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "18.214.36.206"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
